...
<script>
    ...
    function openPopup(thevalue) {
        ...
        var newPath = currentPath.replace("aucor-database-manager/", "detail.php?value="+thevalue);
...
if (isset($_SESSION['module'])){
    $stevevariable=$_SESSION['module'];
    echo "passing on $stevevariable";
 }
if (isset($stevevariable)){
    echo "recieving $stevevariable";
}else{
    echo "";
}
